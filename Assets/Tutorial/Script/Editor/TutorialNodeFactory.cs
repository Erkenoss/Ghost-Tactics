...
namespace Tutorial
{
    ...
    internal sealed class TutorialNodeFactory
    {
        ...
        /// <summary>
        /// Create a visual graph node representing a supported Unity object
        /// </summary>
        /// <param name="target"></param>
        /// <param name="position"></param>
        /// <param name="onClicked"></param>
        /// <returns></returns>
        public VisualElement CreateNode(UnityObject target, Vector2 position, Action<VisualElement, UnityObject> onClicked)
        {
            ...
            Label nameLabel = CreateNodeNameLabel(target);
            ...
            RegisterNodeInteractions(node, target, onClicked);
        ...
        private VisualElement CreateNodeContainer(UnityObject target, Vector2 position)
        {
            ...
            Vector2 nodePosition = CalculateNodePosition(position);
        ...
        /// <param name="target"></param>
        /// <param name="onClicked"></param>
        private void RegisterNodeInteractions(VisualElement node, UnityObject target, Action<VisualElement, UnityObject> onClicked)
        {
            ...
            node.AddManipulator(new NodeDragManipulator(canvas, connectionRenderer.MarkDirty));
        }
